...
function decorateHtmlEmail(input) {
  ...
  return [
    ...
    '<tr><td style="padding:20px 24px;background-color:#0f172a;background-image:linear-gradient(120deg,#0f172a 0%,#1e3a8a 100%);border-bottom:1px solid #1f2937;">',
    '<p style="margin:0;font-size:12px;letter-spacing:.08em;text-transform:uppercase;color:#dbeafe !important;-webkit-text-fill-color:#dbeafe;font-weight:800;">Notification</p>',
    '<h1 style="margin:8px 0 0 0;font-size:20px;line-height:1.35;color:#ffffff !important;-webkit-text-fill-color:#ffffff;font-weight:800;text-shadow:0 1px 2px rgba(0,0,0,0.45);"><span style="color:#ffffff !important;-webkit-text-fill-color:#ffffff;">' + subject + '</span></h1>',
    '</td></tr>',
