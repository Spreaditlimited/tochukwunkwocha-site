...
function decorateHtmlEmail(input) {
  ...
  return [
    ...
    '<tr><td bgcolor="#f8fafc" style="padding:20px 24px;background-color:#f8fafc;border-bottom:1px solid #e2e8f0;">',
    '<p style="margin:0;font-size:12px;letter-spacing:.08em;text-transform:uppercase;color:#475569;font-weight:800;">Notification</p>',
    '<h1 style="margin:8px 0 0 0;font-size:20px;line-height:1.35;color:#0f172a;font-weight:800;"><span style="color:#0f172a;">' + subject + '</span></h1>',
    '</td></tr>',
