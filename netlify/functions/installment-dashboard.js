  ...
  try {
    ...
    return json(200, {
      ...
      account: {
        ...
        whatsappOptedIn: session.account.whatsappOptedIn === true,
        whatsappOptedInAt: session.account.whatsappOptedInAt || null,
        whatsappOptedOutAt: session.account.whatsappOptedOutAt || null,
        schoolStudentCode: session.account.schoolStudentCode || "",
