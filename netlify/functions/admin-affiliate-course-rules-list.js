...
const { listAffiliateCourseRules, listRecentAffiliateAudit, listAffiliateCommissionSummary, ensureAffiliateTables } = require("./_lib/affiliates");
...
exports.handler = async function (event) {
  ...
  try {
    ...
    const commissionSummary = await listAffiliateCommissionSummary(pool);
    ...
    return json(200, { ok: true, rules, courses, audit, commissionSummary });
  } catch (error) {
